...
- [[Features/Strategic Voting]] — the per-method search for voters who could have done better by voting differently: why methods are analyzed in isolation, the utility model, what the search does and does not prove
