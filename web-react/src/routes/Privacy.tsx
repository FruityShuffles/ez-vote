...
// Privacy Policy — ported verbatim from the frozen Flutter reference
// (lib/presentation/screens/privacy_policy_screen.dart). Static copy; keep the
// text identical so the public-facing policy doesn't drift across the cutover.
const SECTIONS: { title: string; body: string }[] = [
  ...
  {
    title: 'Governing Law',
    body: 'This Privacy Policy is governed by the laws of the State of Wisconsin, USA.',
  },
  {
    title: 'Contact',
